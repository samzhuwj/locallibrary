...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        #Get the seventh page and confirm it has (exactly) the remaining 1 items
        resp = self.client.get(reverse('authors')+'?page=7')
        self.assertEqual(resp.status_code, 200)
        self.assertTrue('is_paginated' in resp.context)
        self.assertTrue(resp.context['is_paginated'] == True)
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status='m'
            BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2017', due_back=return_date, borrower=the_borrower, status=status)
    ...
    def test_pages_paginated_to_one(self):    
        ...
        #Confirm that only 1 items are displayed due to pagination (if pagination not enabled, there would be 15 returned)
    ...
    def test_pages_ordered_by_due_date(self):    
        ...
        #Confirm that of the items, only 1 are displayed due to pagination.
        self.assertEqual( len(resp.context['bookinstance_list']),1)
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        self.test_bookinstance1=BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2017', due_back=return_date, borrower=test_user1, status='o')
        
        #Create a BookInstance object for test_user2
        return_date= datetime.date.today() + datetime.timedelta(days=5)
        self.test_bookinstance2=BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2017', due_back=return_date, borrower=test_user2, status='o')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = datetime.date(2017, 11, 20)
